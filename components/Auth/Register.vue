                ...
                <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                    <form>
                        <div class="flex flex-row items-center justify-center lg:justify-start">
                            <p class="mb-0 mr-4 text-lg font-bold font-mono">Sign up</p>
                        </div>
                        ...
                        <div class="relative mb-6" data-te-input-wrapper-init>
                            ...
                            <input type="text" class="peer block min-h-[auto] w-full rounded border-0 py-[0.32rem] px-3 leading-[2.15] outline-none bg-slate-200" id="exampleFormControlInput2" placeholder="" />
                        </div>
                        ...
                        <div class="relative mb-6" data-te-input-wrapper-init>
                            ...
                            <input type="password" class="peer block min-h-[auto] w-full rounded border-0 py-[0.32rem] px-3 leading-[2.15] outline-none bg-slate-200" id="exampleFormControlInput22" placeholder="" />
                        </div>
                        <div class="relative mb-6" data-te-input-wrapper-init>
                            ...
                            <!-- class="pointer-events-none absolute top-0 left-3 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-neutral-200" -->
                            <input type="confirm_password" class="peer block min-h-[auto] w-full rounded border-0 py-[0.32rem] px-3 leading-[2.15] outline-none bg-slate-200" id="exampleFormControlInput222" placeholder="" />
                        </div>
                        ...
                        <div class="text-center lg:text-left">
                            <button type="button" class="inline-block rounded bg-orange-400 px-7 pt-3 pb-2.5 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]" data-te-ripple-init data-te-ripple-color="light">
                                Register
                            </button>
                            <p class="mt-2 mb-0 pt-1 text-sm font-semibold">
                                Already have an account?
                                <a href="/login" class=" text-blue-700 transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700">Login</a>
                            </p>
                        </div>
                    </form>
                </div>
